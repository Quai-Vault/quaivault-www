...
export default function FrontendGuide() {
  ...
  return (
    <DocLayout
      ...
      description="Complete guide to using the Quai Vault web interface effectively."
    >
      {/* App Link */}
      ...
      <div className="vault-panel p-6 mb-6">
        ...
        <div className="space-y-4 text-base text-dark-300">
          ...
          <div>
            ...
            <ul className="space-y-1 ml-4 list-disc">
              <li><strong className="text-dark-200">Wallet Connection:</strong> Connect or disconnect your Pelagus wallet at the top</li>
              <li><strong className="text-dark-200">Create Button:</strong> Create a new vault in a single transaction</li>
        ...
        <div className="space-y-4">
          <div>
            ...
            <ul className="space-y-1 ml-4 list-disc text-base text-dark-300">
              ...
              <li>Current threshold setting, minimum execution delay, and DelegateCall whitelist</li>
          ...
          <div>
            <h3 className="text-base font-display font-bold text-dark-200 mb-2">Creating a Vault</h3>
            <p className="text-base text-dark-300 leading-relaxed mb-2">
              Vault creation is a streamlined single-transaction flow. Click "Create" in the sidebar,
              configure your owners and threshold, and the app handles the rest -- including salt mining
              in the background for deterministic address generation. One wallet confirmation and your
              vault is live.
            </p>
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="border-l-4 border-primary-500 pl-4">
            ...
            <div className="space-y-2 text-base text-dark-300">
              ...
              <p className="mt-2">
                Click "Approve" to add your approval. Changed your mind? You can revoke your approval
                on any pending transaction that hasn't been executed yet.
              </p>
            </div>
          </div>
          ...
          <div className="border-l-4 border-primary-500 pl-4">
            ...
            <div className="space-y-2 text-base text-dark-300">
              ...
              <p>
                If your approval is the final one needed to meet the threshold, you can use
                "Approve & Execute" to approve and execute in a single step -- saving time and gas.
              </p>
              <p>
                Click "Execute" and confirm in your Pelagus wallet. The transaction will be
                executed on-chain and the vault state will update automatically.
              </p>
            </div>
          </div>
        ...
        <div className="space-y-4 text-base text-dark-300">
          ...
          <div>
            ...
            <ul className="space-y-1 ml-4 list-disc">
              ...
              <li><strong className="text-dark-200">Vault Settings:</strong> Manage DelegateCall whitelist — add or remove target addresses that modules can call via DelegateCall (empty by default for security)</li>
            </ul>
          </div>
