        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {docSections.map((section) => (
            <Link
              key={section.path}
              to={section.path}
              className="vault-panel p-6 hover:border-primary-500/50 transition-all group"
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="inline-flex items-center gap-2 text-sm text-primary-500 font-semibold">
                    Read more
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-dark-400">
                  ...
                  and audit reports in the <Link to="/docs/security" className="text-primary-500 hover:text-primary-400 underline">Security</Link> section.
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-dark-400">
                  Found a bug or have a question? Check the <Link to="/docs/faq" className="text-primary-500 hover:text-primary-400 underline">FAQ</Link> or
                  open an issue on <a href={config.githubUrl} target="_blank" rel="noopener noreferrer" className="text-primary-500 hover:text-primary-400 underline">GitHub</a>.
                </p>
              </div>
            </div>
          </div>
